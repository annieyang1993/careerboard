        ...
        <div className = "content">
            ...
            <div className = 'jobs-left'>
                ...
                {authContext.tagFilter.map((tag, i)=>{
                        ...
                        <div for="contract" className = 'dropdown-label-jobs'>Experience level:</div>
                        <Select
                        ...
                        <div className = 'react-select-wrapper-jobs'>
                        <div for="contract" className = 'dropdown-label-jobs'>Tags/Skills:</div>
                        <Select
            ...
            {authContext.filteringBool || authContext.loadingFirebase ? 
